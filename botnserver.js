...
var VAL = require('./values.js'); //All Values
var FUNC = require('./functions.js'); //All Functions
var fs = require("fs");
var isUrl = require("is-url"); //URL Format Validator
var url = require('url');
...
http.createServer(function (req, res) {
  ...
  if(check=="/done/"){
   ...
   return res.end();
    ...
    res.write("<p style='padding: 20px; margin: auto; border: 2px solid black; outline: #27ae60 solid 10px; font-size: 1.3em; background-color: #bdc3c7; color: #16a085; height : 100px; text-align: center; border-radius : 10px /10px;'><br /><br />PIN : <span style='font-weight:bold; color:#2c3e50'>"+pin+"</span></p>");
    res.end();
  }
  else{
    res.writeHead(200, {'Content-Type': 'text/html'});
